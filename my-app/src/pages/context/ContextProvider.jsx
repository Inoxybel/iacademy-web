...
function ContextProvider({ children }) {
  ...
  const [exercicioConteudoSelecionado, setExercicioConteudoSelecionado] =
    useState()
...
export const useGeralContext = () => {
  ...
  if (!context) {
    throw new Error(
      'useGeralContext deve ser usado dentro de um ContextProvider'
    )
  }
  return context
}
